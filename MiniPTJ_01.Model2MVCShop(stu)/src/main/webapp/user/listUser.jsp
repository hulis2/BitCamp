	...
	%>
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:80px">
				<option value="0" <%= (searchVO.getSearchCondition().equals("0") ? "selected" : "")%>>회원ID</option>
				<option value="1" <%= (searchVO.getSearchCondition().equals("1") ? "selected" : "")%>>회원명</option>
			</select>
			<input 	type="text" name="searchKeyword"  value="<%=(searchVO.getSearchKeyword().equals("null") ? "" : searchVO.getSearchKeyword()) %>" 
