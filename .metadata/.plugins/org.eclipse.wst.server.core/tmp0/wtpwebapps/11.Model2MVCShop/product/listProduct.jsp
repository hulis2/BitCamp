							...
							success : function(JSONData , status) {
								...
								$.each(JSONData, function(i, product) {
									...
									if(product.proTranCode == null ){
										 append_node += "<span>"
										 append_node += "<a href='#' class='btn btn-primary' role='button' data-prodNo='${product.prodNo}' data-menu='${param.menu}' >구매</a>"
										 append_node += "</span>"
									}
									
									if(product.proTranCode != null ){
										 append_node += "<span>"
									     append_node += "<a href=''##' class='btn btn-primary' role='button'>품절</a>"
									     append_node += "</span>"
									}
									append_node += "</div>"
									append_node += "</span>"
    					...
    					<div class="thumbnail">
    						<div title="" align="center" class="image" data-prodNo="${product.prodNo}">
        						...
        						<c:choose>
        							...
        							<c:otherwise>
        								<span>
        									<a href="##" class="btn btn-primary" role="button" >품절</a>
        								</span>
        							</c:otherwise>
        						</c:choose>
     					</div>
    						...
    						<div title="" align="center" class="image" data-prodNo="${product.prodNo}">
        						...
        						<c:choose>
        							...
        							<c:when test="${product.proTranCode == 0}">
        								...
        								<span>
        									<a href="###" class="btn btn-primary" role="button" data-prodNo="${product.prodNo}" data-proTranCode="1" >배송</a>
        								</span>
        							</c:when>
        							<c:otherwise>
        								<span class="col-sm-3">
  					...
  					<span class="col-sm-6 col-md-3" >
    					<div class="thumbnail">
    						<div title="" align="center" class="image" data-prodNo="${product.prodNo}">
        						...
        						<span>
        							<a href="#" class="btn btn-primary" role="button" data-prodNo="${product.prodNo}" data-menu="${param.menu}" >확인</a>
        						</span>
        				</div>
 					 </span>
				</span>
